...
def exec_trial(conf, run, ckp_dir=None):
    ...
    for epoch in numpy.arange(0, max_epoch):
        ...
        if epoch_results['val_obj'] <  best_results:
            ...
            best_model_path = '/home/ubuntu/results/'+model_type+'/best_model.pth'
...
if __name__ == "__main__":
    # Load configuration
    with open("drive/conf_pann_distilbert.yaml", "rb") as stream:
    ...
    run = wandb.init(
        name=conf["model_type"],  ## Wandb creates random run names if you skip this field
